      ...
      <form>
        <div className="modal-conferm-inner">
          <div className="modal-conferm-head flex-center">
            <h3 className="title ml-auto">إضافة تصنيف جديد</h3>
            <button
              onClick={() => setIsShowAddNewCategory(false)}
...
AddNewCategory.propTypes = {
  setIsShowAddNewCategory: PropTypes.func,
  featchData: PropTypes.func,
};
